...
import ch.ffhs.esa.lifeguard.ui.ClockTickFormatter;
...
public class MainActivityTest extends ActivityUnitTestCase<MainActivity>
{
    ...
    public final void testLayout ()
    {
        ...
        // We cannot really test this, since the layout itself is not aware of
        // the correct value - the layout gets initialized with the default
        // value that gets overriden by the services real value (that gets
        // fetched from the configuration and set by the value according the
        // configuration or the default value. We would need to make sure the
        // service has already replied with its status message and the initial
        // view has already setup the screen).
//        String tickValue = activity
//                .getSharedPreferences (Lifeguard.APPLICATION_SETTINGS, 0)
//                .getString (
//                        "alarmDelay",
//                        activity.getString (ch.ffhs.esa.lifeguard.R.string.main_value_delay));
//
//        long maxTick = Long.parseLong (tickValue);
//
//        TextView delayView = (TextView) activity.findViewById (delayViewId);
//        assertEquals (ClockTickFormatter.format (0L, maxTick), delayView.getText ());
        ...
        TextView alarmSwitchLabel = (TextView) activity
                .findViewById (alarmSwitchLabelId);
        assertEquals (
        ...
        ToggleButton alarmSwitch = (ToggleButton) activity
                .findViewById (alarmSwitchId);
    ...
    /**
     * Test method for
     * {@link ch.ffhs.esa.lifeguard.MainActivity#openConfiguration()}.
     */
    public final void testOpenConfiguration ()
    {
        ...
        assertEquals (ConfigurationActivity.class.getName (), triggeredIntent
    ...
    public final void testViewContacts ()
    {
        ...
        Intent triggeredIntent = getStartedActivityIntent ();
        assertNotNull ("Intent was null", triggeredIntent);
        assertEquals (ContactListActivity.class.getName (), triggeredIntent
                .getComponent ().getClassName ());
    }
}
