...
public class MainActivityFunctionalTest extends
	...
	public final void testStartOfConfigurationActivity() {
		...
		getInstrumentation().invokeMenuActionSync(activity,
				ch.ffhs.esa.lifeguard.R.id.action_configuration, 0);

		ConfigurationActivity configurationActivity = (ConfigurationActivity) monitor
	...
	public final void testStartOfContactListActivity() {
		...
		getInstrumentation().sendKeyDownUpSync(KeyEvent.KEYCODE_MENU);
		getInstrumentation().invokeMenuActionSync(activity,
				ch.ffhs.esa.lifeguard.R.id.action_contact_list, 0);

		ContactListActivity contactListActivity = (ContactListActivity) monitor
				.waitForActivityWithTimeout(2000);
